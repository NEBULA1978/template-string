// Dada una palabra buscarla en una frase y devolver cuantas veces aparece en ella.La frase y la palabra deben ser parametro de una funcion.ejemplo: coincidencias("soy la frase", "victor")  
...
var frase = (prompt("¿Introduce la frase a comporbar?", 1));
var busqueda = (prompt("¿Introduce la palabra a comprobar?", 1));
